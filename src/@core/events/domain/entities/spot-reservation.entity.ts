...
export class SpotReservation extends AggregateRoot {
  ...
  constructor(props: SpotReservationConstructorProps) {
    ...
    this.spot_id = props.spot_id instanceof EventSpotId ? props.spot_id : new EventSpotId(props.spot_id);
  ...
  static create(command: SpotReservationCreateCommand): SpotReservation {
    return new SpotReservation({
      spot_id: command.spot_id instanceof EventSpotId ? command.spot_id : new EventSpotId(command.spot_id),
      reservation_date: new Date(),
      customer_id: command.customer_id,
    });
  }

  changeReservation(customer_id: CustomerId): void {
